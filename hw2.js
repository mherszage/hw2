...
let totalBrian = blockchain[0].amount - blockchain[1].amount - blockchain[2].amount - blockchain[4].amount + blockchain[5].amount
// console.log(totalBrian);
let totalBen = blockchain[1].amount - blockchain[3].amount + blockchain[6].amount
// console.log(totalBen);
let totalJeff = blockchain[2].amount + blockchain[3].amount + blockchain[4].amount - blockchain[5].amount - blockchain[6].amount
// console.log(totalJeff);

console.log(blockchain[1].fromUser + "'s KelloggCoin balance is " + totalBrian);
console.log(blockchain[3].fromUser + "'s KelloggCoin balance is " + totalBen);
console.log(blockchain[5].fromUser + "'s KelloggCoin balance is " + totalJeff);
